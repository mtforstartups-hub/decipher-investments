        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-20">
          <div className="md:col-span-5 pr-8">
            ...
            <p className="text-white/60 text-sm leading-relaxed max-w-sm mb-8">
              A global private markets platform operating at the intersection of
              strategic capital and enterprise commercialization.
            </p>

            <form className="max-w-xs" onSubmit={(e) => e.preventDefault()}>
              <label
                htmlFor="newsletter"
                className="block text-xs font-bold tracking-widest uppercase text-white/50 mb-3"
              >
                Market Intelligence
              </label>
              <div className="flex border-b border-white/20 focus-within:border-white/50 transition-colors">
                ...
                <button
                  type="submit"
                  className="p-2 text-white/50 hover:text-decipher-yellow transition-colors"
                >
          ...
          <div className="md:col-span-2">
            <h4 className="text-xs font-bold tracking-widest uppercase text-white/50 mb-6">
              Platform
            </h4>
            <ul className="space-y-4 text-sm font-medium">
              <li>
                <Link
                  to="/solutions"
                  className="hover:text-decipher-yellow transition-colors"
                >
                  Solutions
                </Link>
              </li>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-5 text-sm">
              ...
              <li className="flex items-start">
                ...
                <a
                  href="mailto:abhishek@decipherinvestments.com"
                  className="text-white/80 hover:text-decipher-yellow transition-colors"
                >
