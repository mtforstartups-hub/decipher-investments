      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12 mb-16">
          <div className="space-y-4">
            <Link
              to="/"
              className="block text-2xl font-display font-bold tracking-tight text-navy"
            >
              <img
                src={logo}
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <nav className="flex flex-wrap items-center gap-x-8 gap-y-4 text-sm font-medium text-muted">
            <Link to="/investors" className="hover:text-navy transition-colors">
              For Investors
            </Link>
            <Link to="/startups" className="hover:text-navy transition-colors">
              For Startups
            </Link>
            ...
            <Link to="/cookies" className="hover:text-navy transition-colors">
              Cookie Policy
            </Link>
          </nav>
          <p className="text-sm font-medium text-muted">
            © {new Date().getFullYear()} Decipher
          </p>
        </div>
      </div>
    </footer>
